                ...
                <nav id="main-navbar" class="navbar navbar-default navbar-fixed-top" role="navigation"> <!-- Classes: navbar-default, navbar-inverse, navbar-fixed-top, navbar-fixed-bottom, navbar-transparent. Note: If you use non-transparent navbar, set "height: 98px;" to #header -->
                  ...
                  <div class="container">
                    ...
                    <div class="navbar-header">
                      ...
                      <a class="navbar-brand page-scroll" href="index.html">Jeeno</a>
                    </div>
					...
					<div class="caption text-center text-white" data-stellar-ratio="0.7">
						...
						<div id="owl-intro-text" class="owl-carousel">
							<div class="item">
								...
								<p>Profile Panuwat Saisurin</p>
                                <div class="extra-space-l"></div>
								<a class="btn btn-blank" href="https://creativemarket.com/Themetorium" target="_blank" role="button">View More!</a>
							</div>
							<div class="item">
								<h1>I'm Jeeno</h1>
								<p>Student in Information Technology</p>
								<div class="extra-space-l"></div>
								<a class="btn btn-blank" href="<?php echo site_url('geeno/geeno1');?>" target="_blank" role="button">View More!</a>
							</div>
							<div class="item">
								<h1>Study At Rajamangala University of Technology LannaTak</h1>
								<p>The Virtual Information Technology Conference Science And Agricultural Technology</p>
								<div class="extra-space-l"></div>
								<a class="btn btn-blank" href="https://sat.rmutl.ac.th/" target="_blank" role="button">View More!</a>
							</div>
						</div>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="rotate-box-1 square-icon wow zoomIn" data-wow-delay="0">
                                    ...
                                    <div class="rotate-box-info">
                                        <h4>Who We Are?</h4>
                                        <p>นักศึกษา สาขา เทคโนโลยีสารสนเทศ คณะ วิทยาศาสตร์ และ เทคโนโลยีการเกษตร</p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="rotate-box-1 square-icon wow zoomIn" data-wow-delay="0.2s">
                                    ...
                                    <div class="rotate-box-info">
                                        <h4>What We Do?</h4>
                                        <p>ปัจจุบันกำลังศึกษา อยู่ใน มหาวิทยาลัยเทคโนโลยีล้านนาตาก</p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="rotate-box-1 square-icon wow zoomIn" data-wow-delay="0.4s">
                                    ...
                                    <div class="rotate-box-info">
                                        <h4>Why We Do It?</h4>
                                        <p>ต้องการศึกษาหาความรู้และประสบการณ์ ไว้ใช้ในการทำงานในอนาคต</p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="rotate-box-1 square-icon wow zoomIn" data-wow-delay="0.6s">
                                    ...
                                    <div class="rotate-box-info">
                                        <h4>Since When?</h4>
                                        <p>เริ่มเข้าศึกษมหาวิทยาลัยาเมื่อ ปี 2562</p>									         
									</div>
                                </a>
                            </div>
                ...
                <div class="rotate-box-2-wrapper">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="rotate-box-2 square-icon text-center wow zoomIn" data-wow-delay="0">
                                    ...
                                    <div class="rotate-box-info">
                                        ...
                                        <p>เคยเขียนแอพบน Android Studio</p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="rotate-box-2 square-icon text-center wow zoomIn" data-wow-delay="0.2s">
                                    ...
                                    <div class="rotate-box-info">
                                        <h4>Ui Design</h4>
                                        <p>ออกแบบเว็บไซค์ข้อมูลส่วนตัว ออกแบบโดยใช้ Wordpress และ Nicepage</p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="rotate-box-2 square-icon text-center wow zoomIn" data-wow-delay="0.4s">
                                    ...
                                    <div class="rotate-box-info">
                                        <h4>Edit Video</h4>
                                        <p>ตัดต่อโปรแกรมโดยใช้ Adobe Premiere Pro</p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="rotate-box-2 square-icon text-center wow zoomIn" data-wow-delay="0.6s">
                                    ...
                                    <div class="rotate-box-info">
                                        <h4>Take Video</h4>
                                        <p>ออกกองถ่าย Video ในงานต่างๆ</p>
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="text-center">
                    		<a class="btn btn-default btn-lg-xl" href="<?php echo site_url('geeno/geeno2');?>" target="_blank" role="button">ดูข้อมูลเพิ่มเติม</a>
                        </div>
                    </div> <!-- /.container -->                       
                </div>
                <!-- End rotate-box-2 -->
                                ...
                                <div class="portfoloi_content_area" >
                                    <div class="portfolio_menu" id="filters">
                                        <ul>
                                            ...
                                            <li><a href="#porfolio_menu" data-filter=".websites">Animal</a></li>
                                            <li><a href="#porfolio_menu" data-filter=".webDesign" >Waterfall</a></li>
                                            <li><a href="#porfolio_menu" data-filter=".appsDevelopment">Sky</a></li>
                                            <li><a href="#porfolio_menu" data-filter=".GraphicDesign">Me</a></li>
                                            <li><a href="#porfolio_menu" data-filter=".responsive">My Team</a></li>
                                        </ul>
                                    </div>
                                        ...
                                        <div class="row"  id="portfolio">
                                            <div class="col-xs-12 col-sm-4 appsDevelopment">
                                                <div class="portfolio_single_content">
                                                    <img src="img/portfolio/sky1.jpg" alt="title"/>
                                                    <div>
                                                        <a href="#">ถ่ายที่อ่างเก็บน้ำ ตำบล แม่วะ อำเภอ เถิน จังหวัด ลำปาง</a>
                                                        <span></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4 GraphicDesign">
                                                <div class="portfolio_single_content">
                                                    <img src="img/portfolio/me.jpg" alt="title"/>
                                                    <div>
                                                        <a href="#">ถ่ายที่ ช่องเย็น จังหวัด กำแพงเพรช</a>
                                                        <span></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4 responsive">
                                                <div class="portfolio_single_content">
                                                    <img src="img/portfolio/t1.jpg" alt="title"/>
                                                    <div>
                                                        <a href="#">หน้าสาขา เทคโนโลยีสารสนเทศ</a>
                                                        <span></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4 webDesign ">
                                                <div class="portfolio_single_content">
                                                    <img src="img/portfolio/waterfall.jpg" alt="title"/>
                                                    <div>
                                                        <a href="#"></a>
                                                        <span></span>
                                                    </div>
                                            ...
                                            <div class="col-xs-12 col-sm-4 appsDevelopment websites">
                                                <div class="portfolio_single_content">
                                                    <img src="img//portfolio/anm1.jpg" alt="title"/>
                                                    <div>
                                                        <a href="#"></a>
                                                        <span></span>
                                                    </div>
                                            ...
                                            <div class="col-xs-12 col-sm-4 GraphicDesign">
                                                <div class="portfolio_single_content">
                                                    <img src="img/portfolio/me2.jpg" alt="title"/>
                                                    <div>
                                                        <a href="#">ถ่ายที่ อุทยานแห่งชาติแม่วะ</a>
                                                        <span></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4 responsive">
                                                <div class="portfolio_single_content">
                                                    <img src="img/portfolio/t2.jpg" alt="title"/>
                                                    <div>
                                                        <a href="#">ล่องแก่งที่อุ้มผาง</a>
                                                        <span></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4 GraphicDesign">
                                                <div class="portfolio_single_content">
                                                    <img src="img/portfolio/me1.jpg" alt="title"/>
                                                    <div>
                                                        <a href="#">ล่องแก่งที่อุ้มผาง</a>
                                                        <span></span>
                                                    </div>
                                            ...
                                            <div class="col-xs-12 col-sm-4 websites">
                                                <div class="portfolio_single_content">
                                                    <img src="img/portfolio/anm2.jpg" alt="title"/>
                                                    <div>
                                                        <a href="#"></a>
                                                        <span></span>
                                                    </div>
			...
			<section id="social-section">
                ...
                <div class="container">
                	<ul class="social-list">
                		<li> <a href="https://web.facebook.com/panuwat.saisurin" class="rotate-box-1 square-icon text-center wow zoomIn" target="_blank" data-wow-delay="0.3s"><span class="rotate-box-icon"><i class="fa fa-facebook"></i></span></a></li>
                		<li> <a href="https://mail.google.com/mail/u/0/#inbox?compose=new" class="rotate-box-1 square-icon text-center wow zoomIn" target="_blank" data-wow-delay="0.5s"><span class="rotate-box-icon"><i class="fa fa-google-plus"></i></span></a></li>
                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="contact-info">
                                    ...
                                    <ul class="contact-address">
			                            <li><i class="fa fa-map-marker fa-lg"></i>&nbsp; 201/2 หมู่ 1 ต.แม่วะ อ.เถิน จ.ลำปาง,<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; New World Tower New York ,<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; New York, USA, 33148</li>
			                            <li><i class="fa fa-phone"></i>&nbsp; 093-227-9149</li>
			                            <li><i class="fa fa-envelope"></i> panuwatgeeno@yourdomain.com</li>
			                        </ul>
                                </div>
                            </div>
